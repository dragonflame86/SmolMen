...
execute align xyz run summon minecraft:block_display ~0.5 ~0.5 ~0.5 {Tags:["smolmen.red_beacon"], Glowing: 1b, block_state:{Name:"minecraft:beacon"}, UUID: [I; -1467071060, -810596892, -2050357980, 210445240]}
