...
execute align xyz run summon minecraft:block_display ~0.5 ~0.5 ~0.5 {Tags:["smolmen.blue_beacon"], Glowing: 1b, block_state:{Name:"minecraft:beacon"}, UUID: [I; -1637312012, 290213109, -2126465606, -935185114], Passengers:[{id:"minecraft:item_display", Tags:["smolmen.blue_beacon.border"]}]}
...
execute as 9e6899f4-114c-4cf5-8140-b5bac8423526 on passengers run item replace entity @s contents with minecraft:arrow[custom_model_data=4]
execute as 9e6899f4-114c-4cf5-8140-b5bac8423526 on passengers run data modify entity @s transformation.scale set value [0f, 0f, 0f]
