...
execute if entity @s[tag=smolmen.blue_beacon,tag=!smolmen.regenerating] if score @s smolmen.id matches 0 positioned ~-15 -64 ~-15 run tag @a[team=red,dx=30,dz=30,dy=400] add smolmen.restricted
